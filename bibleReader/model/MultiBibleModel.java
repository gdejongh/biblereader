...
public interface MultiBibleModel {
	...
	/**
	 * Returns a list of all references given the book.
	 * 
	 * @param book 
	 *            the book of the bible
	 * @return a ReferenceList containing all verses from the given book, or an empty
	 *         list if the book is invalid.
	 */
	public ReferenceList getBookReferences(BookOfBible book); // *

	/**
	 * Returns a list of all references from the given chapter of the given book.
	 * 
	 * @param book
	 *            the book of the Bible
	 * @param chapter
	 ...
	 *         of the given book; or an empty list if the passage is invalid in this Bible.
	 */
	public ReferenceList getChapterReferences(BookOfBible book, int chapter); // *

	/**
	 * Returns a list of all references from startVerse to endVerse.
	 * 
	 * @param firstVerse
	 *            the starting verse of the passage
	 * @param lastVerse
	 *            the final verse of the passage
	 * @return a ReferenceList of all references between the startVerse and
	 *         endVerse; or an empty list if the range of verses is invalid 
	 *         in this Bible.
	 */
	public ReferenceList getPassageReferences(Reference startVerse, Reference endVerse); // *

	/**
	 * Returns a list of all references from chapter1 to chapter2 given the book;
	 * 
	 * @param book
	 *            the book of the Bible
	 * @param chapter1
	 ...
	 * @param chapter2
	 *            the chapter of the book
	 * @return a ReferenceList containing all references from chapters1 to chapters2
	 *         of the given book; or an empty list if the passage is invalid in this Bible.
	 */
